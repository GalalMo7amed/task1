...
export default function CardsOffersslider() {
    return (
        <div className='relative'>

            <div className="w-[90%] lg:w-[65%] h-full mx-auto pt-[50px] z-50">
                <h2 className='text-[#1F2247] text-[24px] font-[700]'>
                    عرض لفترة محدودة
                </h2>
                <p className='text-[18px] font-[500]'>
                    عروض حصرية لفترة محدودة وباسعار خيالية
                </p>
                <div className='lg:flex lg:justify-center lg:items-center gap-[16px] mt-4'>
...

                    {
                        cards.map((item, index) => (
                            <div className='mx-auto my-5 lg:mx-0 lg:my-0 h-[357px] w-[282px] rounded-[10px] bg-white border border-[#E2E2E2]' key={index}>
            ...
            <div className='bannars  w-[680px] h-[666px] absolute top-0 left-0 -z-10'>
